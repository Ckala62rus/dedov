                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <template v-slot:actions="{row}">
                                ...
                                <Link :href="route('organizations.edit', {id: row.id})" method="get">
                                ...
                                <a href="javascript:;" @click="deleteOrganization(row)">
...
export default {
    ...
    data() {
        return {
            url: '/admin/organization-all-paginate',
            columns: [
                'id',
                'name',
                'description',
    ...
    methods: {
        deleteOrganization(row) {
            Swal.fire({
                ...
                text: "Выбранная организация будет удалена",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    axios.delete('/admin/organizations/' + row.id).then(response => {
                        this.$notify({
                            group: 'foo',
                            type: 'success',
