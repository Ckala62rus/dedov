...
export default {
    ...
    methods: {
        updateBackupObject() {
            ...
            axios.put('/admin/backup-objects/' + this.id, this.form)
                .then(res => {
                    if (res.status === 200){
                        this.$notify({
        ...
        getBackupObject(){
            axios
                .get(`/admin/backup-objects/${this.id}`, this.form)
                .then(res => {
                    let data = res.data.data.backupObject
                    this.form = {
                        name: data.name,
